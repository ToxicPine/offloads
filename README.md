...
From inside Claude Code or Codex, a single `/offload` command sets up a remote
dev computer that matches the machine you work on, copying over your software
