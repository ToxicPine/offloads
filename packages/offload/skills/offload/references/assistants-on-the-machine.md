...
safe command composition, and each harness's launch invocation. A run consults this file only when
the harness needs setup, authentication, or remote control.
